...
|---|---|---|
| 📊 [e-Commerce Sales Report](https://github.com/r-kish/eCommerce-Sales-Dashboard) | As the co-founder of an online business, I extracted monthly and yearly sales reports from eBay, Poshmark, and Mercari to conduct marketing data analysis in order to provide the owner with insights on online sales and customers' behaviors. Data cleaning and transformation was done in SQL, while visualizations were built in Tableau and compiled into an interactive dashboard. | [Dashboard](https://public.tableau.com/app/profile/richard.kish/viz/2023eCommerceSalesDashboard/Dashboard1) |
